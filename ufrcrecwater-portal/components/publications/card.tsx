...
export default function PublicationCard(props: Publication) {
    return (
        <div className="h-128 w-full flex items-start justify-start gap-4 rounded-2xl bg-[#302370] shadow-gray-600 shadow-lg overflow-hidden">
            ...
            <div
                key={props.id}
                className="w-max p-2 flex flex-col gap-1 justify-start rounded-2xl bg-[#302370]"
            >
