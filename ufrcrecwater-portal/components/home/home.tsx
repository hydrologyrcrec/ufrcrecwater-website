...
import { mockSlides1 } from "@/data/home";
...
export default function Home(){
    ...
    useEffect(() => {
        setSlidesData(mockSlides1)
        setSlidesLength(mockSlides1.length)
    ...
    return (
        <div className="relative w-10/12 h-10/12 shadow-gray-600 shadow-xl rounded-2xl overflow-hidden">
            ...
            <Background id={data[currentSlide].slide_info.id} s3_url={mockSlides1[currentSlide].slide_info.s3_url}></Background>
