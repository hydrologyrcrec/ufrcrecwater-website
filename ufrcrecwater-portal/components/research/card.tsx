...
export default function ResearchCard(props: Research) {
    return (
        <div key={props.id + "_card"} className="w-84 h-150 md:h-96 md:w-180 lg:w-250 flex flex-col md:flex-row md:items-stretch md:justify-start rounded-2xl shadow-xl bg-[#afafaf] shadow-gray-600 overflow-hidden">
            <div className="h-96 md:h-full md:flex md:justify-start md:shrink-0 md:items-start">
